...
namespace Kotabko.Migrations
{
    ...
    [Migration("20230406135829_Add order and orderitem migration")]
    partial class Addorderandorderitemmigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kotabko.Models.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Kotabko.Models.Book", b =>
                {
                    ...
                    b.HasOne("Kotabko.Models.Category", "Category")
                        .WithMany("books")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Kotabko.DataAccess.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
